...
var sprite_texture = preload("res://assets/good_block_a.tres")  # Replace with the actual texture path
...
# Function to spawn a Sprite2D at the center of each cell and scale it to fit
func spawn_sprites():
